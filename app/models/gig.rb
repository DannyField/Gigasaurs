class Gig < ApplicationRecord
    ...
    # A band might have a gig poster, so they can use Active Storage and Active Record to upload gig posters
    has_one_attached :picture_upload

end

# Sure, someone could create a user account and then a band account and populate fake gigs. For future release I would look at authenication that ensures that a band is legit.