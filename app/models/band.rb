class Band < ApplicationRecord
  ...
  # A band has many gigs. Even if it's just one, 
  # it will allow the band to create many gigs.
  has_many :gigs
  ...
  # However I need to create a way to tell the user that the band 
  # wasn't created. Currently it goes back to the band page.
end
